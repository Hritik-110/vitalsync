...
//     <div className='flex flex-col sm:flex-row itemx-start gap-5 mt-5'>
...
//         <p onClick={()=> speciality === 'Gastroenterologist' ? navigate('/doctors') : navigate('/doctors/Gastroenterologist') } className={'w-[94vw sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transiton-all cursor-pointer'}>Gastroenterologist</p>
//       </div>
